"""Build the single-file Kaggle script for Atom Language Field v1."""
...
SOURCE_FILES = (
    ...
    PROJECT_ROOT / "atom_language_experiment.py",
)
...
def build_bundle(output_dir: Path) -> dict[str, object]:
    ...
    bundle_path = output_dir / "atom_language_field_kaggle.py"
    sections = [
    ...
    bundle = (
        '"""Generated single-file Kaggle bundle for Atom Language Field v1."""\n\n'
        "from __future__ import annotations\n\n"
        + BUNDLE_IMPORTS
        + "\n"
        + "\n\n".join(sections)
    ...
    metadata = {
        "id": "jessealicea/atom-emergent-language-field-v1",
        "title": "Atom Emergent Language Field v1",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "kaggle" / "language-field-v1",
    )
